...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=1.0\textwidth]{figures/size_dist_annotations.png}
  Visualization of the Test subset of the DN 2010 - 2020 (In-set) dataset.
  \end{center}
  \caption{\textbf{Left}: Number of annotations per annotation group. \textbf{Right}: Distribution of annotations by squareroot area.}
...
\textbf{TODO average over 5 runs}
...
\begin{table}[H]
  \begin{center}
    ...
    \resizebox{\columnwidth}{!}{
    \begin{tabular}{l|l|l|l|l|l|l}
    \textbf{\% Train} & \textbf{$mAP_m$} & \textbf{$mAP_m^{50}$} & \textbf{$mAP_m^{75}$} & \textbf{$mAP_{bb}$} & \textbf{$mAP_{bb}^{50}$} & \textbf{$mAP_{bb}^{75}$} \\
    \hline
    25\% & 0.460 & 0.690 & 0.482 & 0.448 & 0.597 & 0.430 \\    \hline
    50\% & 0.747 & 0.832 & 0.790 & 0.713 & 0.832 & 0.789 \\    \hline
    75\% & 0.750 & 0.822 & 0.808 & 0.752 & 0.822 & 0.810 \\     \hline
    90\% & 0.595 & 0.664 & 0.620 & 0.592 & 0.665 & 0.617 \\     \hline
    100\% & 0.851 & 0.944 & 0.875 & 0.842 & 0.943 & 0.878 \\     \hline
    \end{tabular}}
  \end{center}
\end{table}
...
\begin{table}[H]
  \begin{center}
    ...
    \textbf{\% Train} & \textbf{$mAP_m$} & \textbf{$mAP_m^{50}$} & \textbf{$mAP_m^{75}$} & \textbf{$mAP_{bb}$} & \textbf{$mAP_{bb}^{50}$} & \textbf{$mAP_{bb}^{75}$} \\
    \hline
    25\% & 0.220 & 0.309 & 0.219 & 0.210 & 0.309 & 0.218 \\    \hline
    50\% & 0.376 & 0.459 & 0.378 & 0.365 & 0.457 & 0.374 \\    \hline
    75\% & 0.343 & 0.409 & 0.366 & 0.336 & 0.409 & 0.361 \\     \hline
    90\% & 0.275 & 0.350 & 0.287 & 0.267 & 0.352 & 0.290 \\     \hline
    100\% & 0.414 & 0.481 & 0.430 & 0.402 & 0.481 & 0.423 \\     \hline
    \end{tabular}}
  \end{center}
\end{table}
...
\begin{table}[H]
  \begin{center}
    ...
    \textbf{\% Train} & \textbf{$mAP_m$} & \textbf{$mAP_m^{50}$} & \textbf{$mAP_m^{75}$} & \textbf{$mAP_{bb}$} & \textbf{$mAP_{bb}^{50}$} & \textbf{$mAP_{bb}^{75}$} \\
    \hline
    25\% & 0.389 & 0.476 & 0.423 & 0.377 & 0.474 & 0.413 \\    \hline
    50\% & 0.330 & 0.425 & 0.355 & 0.325 & 0.425 & 0.353 \\    \hline
    75\% & 0.288 & 0.368 & 0.310 & 0.282 & 0.368 & 0.310 \\     \hline
    90\% & 0.290 & 0.356 & 0.310 & 0.279 & 0.355 & 0.289 \\     \hline
    100\% & 0.488 & 0.599 & 0.527 & 0.451 & 0.598 & 0.461 \\    \hline
    \end{tabular}}
  \end{center}
\end{table}
