...
Label studios was used to produce the labels for the datasets created in this thesis. In the interest of time, labels were first created using rectangles, exported, converted to polygons, and then imported again to be reviewed and edited where necessary. 
...
A linear learning rate configuration was used. The learning rate was divided by 5 every 8th epoch.
...
\textbf{Normalization}. In the MMDetection framework, we found that pixel color was represented in the range of $[0.0,1.0]$ instead of the more familiar range of $0-255$ for RGB values.
