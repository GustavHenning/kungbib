...
In \Cref{ch:background}, we introduce the historical background to understand the subject matter, the preliminaries for grasping the proposed solution, and recap the previous work in document segmentation.

\Cref{ch:method} begins with a detailed description of the dataset created from the data accessed at the National Library of Sweden.
Next, the neural network employed in the study is introduced in \Cref{sec:modelarch}, and the relevant adaptations to the pre-processing and manipulation of the data is explained.
...
All model results in this section are sorted by the \textbf{$mAP_m$}, the mean Average Precision for the segmentation mask. \textbf{TODO Not all results are in}

\begin{table}[H]
  \begin{center}
    \caption{Top 5 results - 6 classes - In-set}
...
\begin{table}[H]
  \begin{center}
    \caption{Top 5 results - 6 classes - Near-set}
...
\begin{table}[H]
  \begin{center}
    \caption{Top 5 results - 6 classes - Out-set}
...
\begin{table}[H]
  \begin{center}
    \caption{Top 5 results - 1 class - In-set}
...
\begin{table}[H]
  \begin{center}
    \caption{Top 5 results - 1 class - Near-set}
...
\begin{table}[H]
  \begin{center}
    \caption{Gradually increasing dataset size - 6 classes - Near-set}
...
\begin{table}[H]
  \begin{center}
    \caption{Gradually increasing dataset size - 6 classes - Out-set}
...
\begin{table}[H]
  \begin{center}
    \caption{Gradually increasing dataset size - 1 class - In-set}
...
\begin{table}[H]
  \begin{center}
    \caption{Gradually increasing dataset size - 1 class - Near-set}
...
\item The first 3 dimensions of "all-mpnet-base-v2" vector representations normalized as RGB colors.
\item The Ground Truth label bounding boxes visualized on a black background. Colors correspond to class.
...
\begin{subfigure}{0.75\textwidth}
  \centering
  \includegraphics[width=\linewidth, clip=true, trim = 20mm 20mm 30mm 0mm]{figures/ocr/JIefsDa.png}
  \caption{OCR bounding boxes in red}
  \label{fig:JIefsDa_OCR}
\end{subfigure}%
\begin{subfigure}{0.75\textwidth}
  \centering
  \includegraphics[width=\linewidth, clip=true, trim = 20mm 20mm 30mm 0mm]{figures/tf/JIefsDa.png}
...
\end{subfigure}}
\end{adjustbox}
  \caption{A front page newspaper page from the DN 2010-2020 Test subset. *In (b) the first 3 dimensions of "all-mpnet-base-v2" vector representations normalized as RGB colors. in (c) and (d) Teal labels are News units, purple is Advertisement.}
\label{fig:JIefsDa}
\end{figure}
...
\begin{subfigure}{0.75\textwidth}
  \centering
  \includegraphics[width=\linewidth, clip=true, trim = 20mm 20mm 30mm 0mm]{figures/ocr/zk6UnuL.png}
  \caption{OCR bounding boxes in red}
  \label{fig:zk6UnuL_OCR}
\end{subfigure}%
\begin{subfigure}{0.75\textwidth}
  \centering
  \includegraphics[width=\linewidth, clip=true, trim = 20mm 20mm 30mm 0mm]{figures/tf/zk6UnuL.png}
  \caption{Text Embeddings*}
  \label{fig:zk6UnuL_TF}
\end{subfigure}
  \centering
\begin{subfigure}{0.6\textwidth}
  \centering
...
\end{subfigure}}
\end{adjustbox}
  \caption{A newspaper page with listing prices of funds and stocks from the DN 2010-2020 Test subset. *In (b) the first 3 dimensions of "all-mpnet-base-v2" vector representations normalized as RGB colors. In (c) and (d) Bright purple label is Advertisement, dark purple labels are Listings.}
\label{fig:zk6UnuL}
\end{figure}
...
\begin{subfigure}{0.75\textwidth}
  \centering
  \includegraphics[width=\linewidth, clip=true, trim = 20mm 20mm 30mm 0mm]{figures/ocr/GQU6vjW.png}
  \caption{OCR bounding boxes in red}
  \label{fig:GQU6vjW_OCR}
\end{subfigure}%
\begin{subfigure}{0.75\textwidth}
  \centering
  \includegraphics[width=\linewidth, clip=true, trim = 20mm 20mm 30mm 0mm]{figures/tf/GQU6vjW.png}
  \caption{Text Embeddings*}
...
\end{subfigure}}
\end{adjustbox}
  \caption{A newspaper page with obituaries from the DN 2010-2020 Test subset. *In (b) the first 3 dimensions of "all-mpnet-base-v2" vector representations normalized as RGB colors. In (c) and (d) Bright green labels are Death Notice (obituaries).}
\label{fig:GQU6vjW}
\end{figure}
...
\begin{subfigure}{0.75\textwidth}
  \centering
  \includegraphics[width=\linewidth, clip=true, trim = 20mm 20mm 30mm 0mm]{figures/ocr/AVThDFz.png}
  \caption{OCR bounding boxes in red}
  \label{fig:AVThDFz_OCR}
\end{subfigure}%
\begin{subfigure}{0.75\textwidth}
  \centering
  \includegraphics[width=\linewidth, clip=true, trim = 20mm 20mm 30mm 0mm]{figures/tf/AVThDFz.png}
  \caption{Text Embeddings*}
...
\end{subfigure}}
\end{adjustbox}
  \caption{A newspaper page consisting of news articles from the DN 2010-2020 Test subset. *In (b) the first 3 dimensions of "all-mpnet-base-v2" vector representations normalized as RGB colors. in (c) and (d) Teal labels are News units.}
\label{fig:AVThDFz}
\end{figure}
...
\begin{subfigure}{0.75\textwidth}
  \centering
  \includegraphics[width=\linewidth, clip=true, trim = 20mm 20mm 30mm 0mm]{figures/ocr/Jd55Bvg.png}
  \caption{OCR bounding boxes in red}
  \label{fig:Jd55Bvg_OCR}
\end{subfigure}%
\begin{subfigure}{0.75\textwidth}
  \centering
  \includegraphics[width=\linewidth, clip=true, trim = 20mm 20mm 30mm 0mm]{figures/tf/Jd55Bvg.png}
  \caption{Text Embeddings*}
  \label{fig:Jd55Bvg_TF}
\end{subfigure}
  \centering
\begin{subfigure}{0.6\textwidth}
  \centering
...
\end{subfigure}}
\end{adjustbox}
  \caption{A newspaper page consisting of weather reports and advertisement from the DN 2010-2020 Test subset. *In (b) the first 3 dimensions of "all-mpnet-base-v2" vector representations normalized as RGB colors. In (c) and (d) Blue label is Weather. Purple labels are Advertisement.}
\label{fig:Jd55Bvg}
\end{figure}
\clearpage
...
\begin{subfigure}{0.75\textwidth}
  \centering
  \includegraphics[width=\linewidth, clip=true, trim = 20mm 20mm 30mm 0mm]{figures/ocr/1RoKim0.png}
  \caption{OCR bounding boxes in red}
  \label{fig:1RoKim0_OCR}
\end{subfigure}%
\begin{subfigure}{0.75\textwidth}
  \centering
  \includegraphics[width=\linewidth, clip=true, trim = 20mm 20mm 30mm 0mm]{figures/tf/1RoKim0.png}
  \caption{Text Embeddings*}
  \label{fig:1RoKim0_TF}
\end{subfigure}
\begin{subfigure}{0.75\textwidth}
  \centering
...
\end{subfigure}}
\end{adjustbox}
  \caption{A newspaper page consisting of a single large image, part of a multi-page article from the DN 2010-2020 Test subset. *In (b) the first 3 dimensions of "all-mpnet-base-v2" vector representations normalized as RGB colors. In (c) and (d) teal label is News unit.}
\label{fig:1RoKim0}
\end{figure}
...
There is always a certain level of ambiguity when deciding what classes and labels are appropriate. Perhaps less so in the example of MS COCO than in this thesis. This is due to the fact that we attempt to create and label elements based on their semantic features, as opposed to purely the visual properties of objects. 
...
as "Advertisement" (because they truly are ads), and that they should be labeled as "News Unit" (because they look like news articles). In this thesis we regard these examples are news articles, because they look like news articles. 
...
As we can see in \Cref{tab:dsizeallcnearset}, \Cref{tab:dsizeallcoutset}, \Cref{tab:dsizeonecnearset}, \Cref{tab:dsizeonecoutset}, performance in near- and out-of-domain test set improves with increasing train dataset size. This supports the aforementioned theory that there are more diverse examples left out of the 75\% subset.
