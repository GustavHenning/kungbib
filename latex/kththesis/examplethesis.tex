...
\textbf{Since we mention this dataset multiple times throughout the thesis, perhaps we should describe it.}
...
For example, a news article might have an image depicting the contents, a title, a body of text possibly spanning multiple paragraphs, and a byline.
These elements are one \textit{instance} of a class.
...
\begin{table}[!htb]
  \begin{center}
    ...
    This thesis & area < X & X < area < X & area > X \\    \hline
    \end{tabular}
  \end{center}
\end{table}
