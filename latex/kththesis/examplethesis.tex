...
Therefore, if an element or group of elements are assigned any class (except background) previously mentioned in \autoref{subs:finalclasses}, they will be labeled as a publication unit in the experiments where class confusion is investigated.
...
Throughout these results, we will divide each section to show results using the classes defined in \autoref{subs:finalclasses} and \autoref{subs:pubunit} respectively.
...
\begin{table}[H]
  \begin{center}
    ...
    r50 &                           0.875 & 0.958 & 0.930 & 0.868 & 0.960 & 0.933 \\    \hline
...
r50-all-mpnet                  & 0.463 & 0.590 & 0.508 & 0.440 & 0.589 & 0.502 \\ \hline
...
x101-32x4d-1c                  & 0.506 & 0.618 & 0.532 & 0.502 & 0.617 & 0.530 \\ \hline
    \end{tabular}}
  \end{center}
\end{table}
...
x101-1c                        & 0.421 & 0.532 & 0.436 & 0.416 & 0.529 & 0.437 \\ \hline
x101-64x4d-1c                  & 0.419 & 0.519 & 0.445 & 0.414 & 0.517 & 0.438 \\ \hline
    \end{tabular}}
  \end{center}
\end{table}
...
As seen \autoref{tab:modeldimensions}, the sentence transformers output their vectors of size $768$ or $384$. This adds a significant number of channels to the input if inserted without alteration. The consequence is a large memory footprint.  
...
\item \textbf{Dataset size}. Dataset size increases could potentially lead to more stable results and a greater diversity in topology and time-period of the training dataset could lead to a greater generalization property.
