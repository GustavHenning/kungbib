...
Based on the newspaper from the National Library of Sweden, we investigate the predictive power of visual and textual features and their capacity to generalize across different typographic designs. Results show impressive mean Average Precision scores (>$0.9$) for test sets sampled from the same newspaper topology as the training data \textit{using only the image modality}.
...
In this chapter, the history of digitization of historical documents will be reviewed. A description of the data accessed at the National Library of Sweden will be produced. Details about how the deep learning model functions will be introduced in \Cref{sec:preliminaries}. Then, we will look at the history of segmentation algorithms, as well as the history of the deep learning model that we intend to extend and evaluate. 
...
Therefore, if an element or group of elements are assigned any class (except background) previously mentioned in \Cref{subs:finalclasses}, they will be labeled as a publication unit in the experiments where class confusion is investigated.
...
\begin{figure}[H]% trim = l b r t
    \centering 
    \subfloat[\centering OCR bounding boxes in red]{{\includegraphics[width=.45\textwidth, clip=true, trim = 50mm 20mm 60mm 0mm]{figures/ocr_bbox/JIefsDa.png} }}%
    \qquad
    \subfloat[\centering First 3 dimensions of all-mpnet-base-v2 vector representations normalized as RGB colors.]{{\includegraphics[width=.45\textwidth, clip=true, trim = 50mm 20mm 60mm 0mm]{figures/tf/JIefsDa.png} }}\\
    \subfloat[\centering Labels produced by vanilla Mask R-CNN, trained on 75\% of the training data. See \Cref{tab:dsizeallcinset}. Teal labels are News units, purple is Advertisement.]{{\includegraphics[width=0.5\textwidth, clip=true, trim = 0mm 0mm 0mm 0mm]{figures/labels-vanilla-0.75/JIefsDa.jpg} }}%
    \caption{A front page newspaper page from the DN 2010-2020 Test subset. Note how large black spaces in (a) and (b) often constitute images with no text inside.}%
    \label{fig:frontpage}%
\end{figure}

\begin{figure}[H]% trim = l b r t
    \centering 
    \subfloat[\centering OCR bounding boxes in red]{{\includegraphics[width=.45\textwidth, clip=true, trim = 50mm 20mm 60mm 0mm]{figures/ocr_bbox/zk6UnuL.png} }}%
    \qquad
    \subfloat[\centering First 3 dimensions of all-mpnet-base-v2 vector representations normalized as RGB colors.]{{\includegraphics[width=.45\textwidth, clip=true, trim = 50mm 20mm 60mm 0mm]{figures/tf/zk6UnuL.png} }}\\
    \subfloat[\centering Labels produced by vanilla Mask R-CNN, trained on 75\% of the training data. See \Cref{tab:dsizeallcinset}. Dark purple labels are Listings.]{{\includegraphics[width=0.5\textwidth, clip=true, trim = 0mm 0mm 0mm 0mm]{figures/labels-vanilla-0.75/zk6UnuL.jpg} }}%
    \caption{A newspaper page with listing prices of funds and stocks from the DN 2010-2020 Test subset.}%
    \label{fig:stocks}%
\end{figure}

\begin{figure}[H]% trim = l b r t
    \centering 
    \subfloat[\centering OCR bounding boxes in red]{{\includegraphics[width=.45\textwidth, clip=true, trim = 50mm 20mm 60mm 0mm]{figures/ocr_bbox/GQU6vjW.png} }}%
    \qquad
    \subfloat[\centering First 3 dimensions of all-mpnet-base-v2 vector representations normalized as RGB colors.]{{\includegraphics[width=.45\textwidth, clip=true, trim = 50mm 20mm 60mm 0mm]{figures/tf/GQU6vjW.png} }}\\
    \subfloat[\centering Labels produced by vanilla Mask R-CNN, trained on 75\% of the training data. See \Cref{tab:dsizeallcinset}. Bright green labels are Death Notice (obituaries).]{{\includegraphics[width=0.5\textwidth, clip=true, trim = 0mm 0mm 0mm 0mm]{figures/labels-vanilla-0.75/GQU6vjW.jpg} }}%
    \caption{A newspaper page with obituaries from the DN 2010-2020 Test subset.}%
    \label{fig:obituaries}%
\end{figure}

\begin{figure}[H]% trim = l b r t
    \centering 
    \subfloat[\centering OCR bounding boxes in red]{{\includegraphics[width=.45\textwidth, clip=true, trim = 50mm 20mm 60mm 0mm]{figures/ocr_bbox/AVThDFz.png} }}%
    \qquad
    \subfloat[\centering First 3 dimensions of all-mpnet-base-v2 vector representations normalized as RGB colors.]{{\includegraphics[width=.45\textwidth, clip=true, trim = 50mm 20mm 60mm 0mm]{figures/tf/AVThDFz.png} }}\\

    \subfloat[\centering Labels produced by vanilla Mask R-CNN, trained on 75\% of the training data. See \Cref{tab:dsizeallcinset}. Teal labels are News units.]{{\includegraphics[width=0.5\textwidth, clip=true, trim = 0mm 0mm 0mm 0mm]{figures/labels-vanilla-0.75/AVThDFz.jpg} }}%
    \caption{A newspaper page consisting of news articles from the DN 2010-2020 Test subset.}%
...
\begin{figure}[H]% trim = l b r t
    \centering 
    \subfloat[\centering OCR bounding boxes in red]{{\includegraphics[width=.45\textwidth, clip=true, trim = 50mm 20mm 60mm 0mm]{figures/ocr_bbox/Jd55Bvg.png} }}%
    \qquad
    \subfloat[\centering First 3 dimensions of all-mpnet-base-v2 vector representations normalized as RGB colors.]{{\includegraphics[width=.45\textwidth, clip=true, trim = 50mm 20mm 60mm 0mm]{figures/tf/Jd55Bvg.png} }}\\

    \subfloat[\centering Labels produced by vanilla Mask R-CNN, trained on 75\% of the training data. See \Cref{tab:dsizeallcinset}. Blue label is Weather. Purple labels are Advertisement.]{{\includegraphics[width=0.5\textwidth, clip=true, trim = 0mm 0mm 0mm 0mm]{figures/labels-vanilla-0.75/Jd55Bvg.jpg} }}%
    \caption{A newspaper page consisting of weather reports and advertisement from the DN 2010-2020 Test subset.}%
    \label{fig:weather}%
\end{figure}

\begin{figure}[H]% trim = l b r t
    \centering 
    \subfloat[\centering OCR bounding boxes in red]{{\includegraphics[width=.45\textwidth, clip=true, trim = 20mm 20mm 30mm 0mm]{figures/ocr_bbox/1RoKim0.png} }}%
    \qquad
    \subfloat[\centering First 3 dimensions of all-mpnet-base-v2 vector representations normalized as RGB colors.]{{\includegraphics[width=.45\textwidth, clip=true, trim = 20mm 20mm 30mm 0mm]{figures/tf/1RoKim0.png} }}\\

    \subfloat[\centering Labels produced by vanilla Mask R-CNN, trained on 75\% of the training data. See \Cref{tab:dsizeallcinset}. Teal label is News unit.]{{\includegraphics[width=0.5\textwidth, clip=true, trim = 0mm 0mm 0mm 0mm]{figures/labels-vanilla-0.75/1RoKim0.jpg} }}%
    \caption{A newspaper page consisting of a single large image, part of a multi-page article from the DN 2010-2020 Test subset.}%
    \label{fig:largeimage}%
\end{figure}
...
As mentioned in \Cref{subs:maskrcnn}, Mask R-CNN performs worse on smaller objects. An experiment will be conducted to investigate if we can exploit the large image sizes in our dataset to improve performance.
