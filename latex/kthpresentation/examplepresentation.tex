...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
  \frametitle{Mask R-CNN Backbones used in this thesis}

\begin{itemize}
\item ResNet-50-FPN (r50)
\item ResNet-101-FPN (r101)
\item ResNeXt-101-32x4d-FPN (x101-32x4d)
\item ResNeXt-101-32x8d-FPN (x101-32x8d)
\item ResNeXt-101-64x4d-FPN (x101-64x4d)
\end{itemize}
...
\begin{subfigure}{0.9\textwidth}
  \centering
  \includegraphics[max size={0.6\textwidth}{0.6\textheight}]{figures/fpn.png}
\end{subfigure}%
  \caption{Evolution of the Feature Pyramid Network (bottom right). [Lin et al 2016]}
\label{fig:fpn}
\end{figure}
